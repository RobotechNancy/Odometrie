...
//
//float MPU6050_GetData_Accelero_Y(void)
//{
//	float AFS_Scale;
//	MPU6050_Data.unified_acc_y = (int16_t)( (MPU6050_Data.raw_acc_y[0] << 8) | MPU6050_Data.raw_acc_y[1]);
//	switch(__Descriptor->Config->Accelero_Sensitivity)
//	{
//	case MPU6050_ACCELERO_SENSITIVITY_2:
//		AFS_Scale = 16384.0f;
...
//		break;
//	}
//	MPU6050_Data.scaled_acc_y = (float)(MPU6050_Data.unified_acc_y) / AFS_Scale;
//	return MPU6050_Data.scaled_acc_y;
//}
//
//float MPU6050_GetData_CF_Accelero_Y(void)
//{
//	Flags.new_data = FALSE;
//	return MPU6050_GetData_Accelero_Y();
//}
//
//float MPU6050_GetData_Accelero_Z(void)
//{
//	float AFS_Scale;
//	MPU6050_Data.unified_acc_z = (int16_t)( (MPU6050_Data.raw_acc_z[0] << 8) | MPU6050_Data.raw_acc_z[1]);
//	switch(__Descriptor->Config->Accelero_Sensitivity)
//	{
//	case MPU6050_ACCELERO_SENSITIVITY_2:
//		AFS_Scale = 16384.0f;
...
//		break;
//	}
//	MPU6050_Data.scaled_acc_z = (float)(MPU6050_Data.unified_acc_z) / AFS_Scale;
//	return MPU6050_Data.scaled_acc_z;
//}
//
//float MPU6050_GetData_CF_Accelero_Z(void)
//{
//	Flags.new_data = FALSE;
