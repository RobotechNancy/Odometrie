...
#define MPU6050_DIVIDER_200Hz 4
#define MPU6050_DIVIDER_100Hz 9
#define MPU6050_DIVIDER_50Hz 19
#define MPU6050_DIVIDER_20Hz 49
#define MPU6050_DIVIDER_10Hz 99
...
// TODO: add enumeration for accelometer sensivity
typedef enum {
	MPU6050_ACCELERO_SENSITIVITY_2 = 0,
	MPU6050_ACCELERO_SENSITIVITY_4,
	MPU6050_ACCELERO_SENSITIVITY_8,
	MPU6050_ACCELERO_SENSITIVITY_16
} MPU6050_Accelero_Senstivity_t;
...
typedef struct {
	...
	MPU6050_Accelero_Senstivity_t Accelero_Sensitivity;
...
float MPU6050_GetData_Accelero(short);
float MPU6050_GetData_CF_Accelero(short);
