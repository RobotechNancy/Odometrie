...
// Définition des adresses d'émmission sur le bus can (de type 0xX00)
typedef enum {
    CAN_ADDR_RASPBERRY = 0x1000000,
    CAN_ADDR_BASE_ROULANTE = 0x2000000,
    CAN_ADDR_BROADCAST = 0x6000000,
	CAN_ADDR_ODOMETRIE = 0xa000000,
} CAN_ADDR;


// 0x0F00000  (cinq 0)
// 0b00000 1111 0000 0000 0000 0000 0000
// Définition des adresses de réception sur le bus can (de type 0xX00)
typedef enum {
    CAN_ADDR_RASPBERRY_E = 0x100000,
    CAN_ADDR_BASE_ROULANTE_E = 0x200000,
    CAN_ADDR_BROADCAST_E = 0xF00000,
	CAN_ADDR_ODOMETRIE_E = 0xa00000,
} CAN_EMIT_ADDR;
